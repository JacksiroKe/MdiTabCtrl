...
#Region " Class GetTabRegionEventArgs "
    ...
    <Description("Provides data for the MdiTabCtrl.TabControl.GetTabRegion event.")> _
    Public Class GetTabRegionEventArgs
        ...
        <Description("Initializes a new instance of the MdiTabCtrl.TabControl.GetTabRegionEventArgs class.")> _
...
#Region " Class TabPaintEventArgs "
    ...
    <Description("Provides data for the MdiTabCtrl.TabControl.TabPaint event.")> _
...
#Region " Class TabPageCollection "
    ...
    <Description("Contains a collection of MdiTabCtrl.TabPage objects.")> _
