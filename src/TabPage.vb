...
<DesignTimeVisible(False), Description("Represents a single tab page in a MdiTabCtrl.TabControl.")> _
Public Class TabPage
    ...
    Friend Event Dragging(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
    Friend Event EndDrag(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
